...
int main() {
  ...
  // Área para exibição e compatação entre as cartas
    
    //exibição da compraração de cada atributo foi suspensa devido as novas especificações do exercidio
  ...
  */
    ...
    //escolhido população como fator de comparação  
